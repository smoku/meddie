defmodule MeddieWeb.CoreComponents do
  @moduledoc """
  ...
  def flash(assigns) do
    ...
    >
      <div class={[
        "alert w-80 sm:w-96 max-w-80 sm:max-w-96 text-wrap shadow-elevated-lg",
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(MeddieWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(MeddieWeb.Gettext, "errors", msg, opts)
    end
  end
